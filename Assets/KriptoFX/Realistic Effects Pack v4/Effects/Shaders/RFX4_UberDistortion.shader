...
#define _Cutout_arr MyProperties
				...
				half2 offset = dist.rg * UNITY_ACCESS_INSTANCED_PROP(_Distortion_arr, _Distortion) * _ColorPyramidTexture_TexelSize.xy * i.color.a * fade;
				...
				half diffMask = cutout - mask;
				half alphaMask = saturate(diffMask * 10000);
				half alphaMaskThreshold = saturate((diffMask - _CutoutThreshold) * 10000);
