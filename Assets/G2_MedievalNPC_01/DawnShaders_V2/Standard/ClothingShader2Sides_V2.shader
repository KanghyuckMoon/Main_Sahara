...
Shader "DawnShader_V2/Clothing2Sides"
{
	Properties
	{
		...
		[Toggle(_USEBACKSIDECOLOR_ON)] _useBackSideColor("use Back Side Color", Float) = 0
		_BackSideColor("Back Side Color", Color) = (0,0,0,0)
		_BackSideMetallic("Back Side Metallic", Range( 0 , 1)) = 0.1
		_BackSideRoughness("Back Side Roughness", Range( 0 , 1)) = 0.1
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _USEBACKSIDECOLOR_ON
		...
		uniform float _BackSideMetallic;
		...
		uniform float _BackSideRoughness;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Normal202 = appendResult175;
			o.Normal = Normal202.xyz;
			...
			float4 switchResult216 = (((i.ASEVFace>0)?(lerpResult87):(_BackSideColor)));
			#ifdef _USEBACKSIDECOLOR_ON
				float4 staticSwitch217 = switchResult216;
			#else
				float4 staticSwitch217 = lerpResult87;
			#endif
			float4 Albedo203 = staticSwitch217;
			o.Albedo = Albedo203.rgb;
			...
			float4 Emission205 = ( ( tex2DNode185.r * tex2DNode183 * _EmissiveBoots1 * _EmissiveColor01 ) + ( tex2DNode185.g * tex2DNode183 * _EmissiveBoots2 * _EmissiveColor02 ) + ( tex2DNode185.b * tex2DNode183 * _EmissiveBoots3 * _EmissiveColor03 ) );
			o.Emission = Emission205.rgb;
			float2 uv_ORM = i.uv_texcoord * _ORM_ST.xy + _ORM_ST.zw;
			float4 tex2DNode198 = tex2D( _ORM, uv_ORM );
			...
			float switchResult222 = (((i.ASEVFace>0)?(lerpResult128):(_BackSideMetallic)));
			#ifdef _USEBACKSIDECOLOR_ON
				float staticSwitch225 = switchResult222;
			#else
				float staticSwitch225 = lerpResult128;
			#endif
			float Metallic211 = staticSwitch225;
			o.Metallic = Metallic211;
			...
			float switchResult219 = (((i.ASEVFace>0)?(lerpResult88):(_BackSideRoughness)));
			#ifdef _USEBACKSIDECOLOR_ON
				float staticSwitch218 = switchResult219;
			#else
				float staticSwitch218 = lerpResult88;
			#endif
			float Smoothness207 = staticSwitch218;
			o.Smoothness = Smoothness207;
			float AO209 = tex2DNode198.r;
			o.Occlusion = AO209;
			o.Alpha = 1;
			...
			#endif
			float4 OpacityMask213 = staticSwitch159;
			clip( OpacityMask213.r - _Cutoff );
		}
...
/*ASEBEGIN
Version=19001
2560;1;2560;1058;2112.669;1781.208;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;198;-1150.52,-1361.438;Inherit;True;Property;_ORM;ORM;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;154;297.1133,-855.9114;Float;False;Property;_DitherBoosts;Dither Boosts;2;0;Create;True;0;0;0;False;0;False;9.5;0;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;633.2468,-1069.086;Float;False;Property;_OpacityBoots;Opacity Boots;3;0;Create;True;0;0;0;False;0;False;0.5;0;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;153;617.1135,-839.9114;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;912.1686,-1022.052;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DitheringNode;155;793.1132,-903.9119;Inherit;False;1;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;215;44.31909,-1949.607;Inherit;False;Property;_BackSideColor;Back Side Color;42;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;220;191.3827,-1205.739;Inherit;False;Property;_BackSideRoughness;Back Side Roughness;44;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;221;854.3787,66.46338;Inherit;False;Property;_BackSideMetallic;Back Side Metallic;43;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;160;858.8605,-1296.612;Float;False;Constant;_ZeroMask;Zero Mask;34;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;156;1094.838,-921.4198;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SwitchByFaceNode;222;1211.277,22.13647;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SwitchByFaceNode;216;300.3192,-1848.607;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SwitchByFaceNode;219;528.3827,-1244.739;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;225;1383.045,-105.8777;Inherit;False;Property;_useBackSideColor;use Back Side Color;41;0;Create;False;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;159;1140.764,-1203.067;Float;False;Property;_OnOffOpacity;On/Off Opacity;1;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;217;526.3191,-1773.607;Inherit;False;Property;_useBackSideColor;use Back Side Color;41;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;218;603.3827,-1439.739;Inherit;False;Property;_useBackSideColor;use Back Side Color;41;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;205;-1525.023,-2898.103;Inherit;False;Emission;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;203;846.96,-1759.662;Inherit;False;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;202;746.9661,-2320.159;Inherit;False;Normal;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;213;1399.456,-1272.339;Inherit;False;OpacityMask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;211;1692.929,-103.4808;Inherit;False;Metallic;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;209;-811.7784,-1458.279;Inherit;False;AO;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;207;896.2503,-1438.619;Inherit;False;Smoothness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;212;2002.867,-1405.352;Inherit;False;211;Metallic;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;206;2003.87,-1475.383;Inherit;False;205;Emission;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;208;1999.258,-1331.71;Inherit;False;207;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;204;2003.854,-1627.852;Inherit;False;203;Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;201;2001.505,-1549.127;Inherit;False;202;Normal;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;210;1998.679,-1251.464;Inherit;False;209;AO;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;214;2002.867,-1166.352;Inherit;False;213;OpacityMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2322.899,-1555.541;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;DawnShader_V2/Clothing2Sides;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.5;True;True;0;True;Opaque;;AlphaTest;ForwardOnly;18;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;True;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;0;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
