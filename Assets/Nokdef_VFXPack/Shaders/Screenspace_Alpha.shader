	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord81 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner80 = ( 1.0 * _Time.y * _DetailNoisePanning + texCoord81);
				float4 tex2DNode79 = tex2D( _DetailNoise, panner80 );
				float4 break2_g63 = ( tex2DNode79 * _DetailDistortionChannel );
				float4 appendResult11_g63 = (float4(break2_g63.x , break2_g63.y , break2_g63.z , break2_g63.w));
				...
				float desaturateDot158 = dot( desaturateInitialColor158, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar158 = lerp( desaturateInitialColor158, desaturateDot158.xxx, _Desaturate );
				float4 texCoord162 = packedInput.ase_texcoord;
				texCoord162.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 break2_g62 = ( tex2DNode79 * _DetailMultiplyChannel );
				float4 appendResult11_g62 = (float4(break2_g62.x , break2_g62.y , break2_g62.z , break2_g62.w));
				float4 temp_cast_7 = (1.0).xxxx;
				float4 temp_cast_8 = (1.0).xxxx;
...
/*ASEBEGIN
Version=18912
274;168;1920;1029;804.3494;926.5048;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;152;158.6752,-1380.28;Inherit;False;Channel Picker;-1;;61;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;127;787.0098,-573.7703;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;13;Nokdef/Screenspace Alpha;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=-250;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;True;True;1;5;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-27;False;False;False;False;False;False;False;False;True;True;False;0;True;-5;255;False;-1;255;True;-6;0;False;-1;0;False;-1;0;False;-1;0;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;2;False;-32;True;3;False;-32;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;  Rendering Pass ;0;  Rendering Pass;0;  Blending Mode;0;  Receive Fog;0;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;0;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;0;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;0;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;False;True;True;True;False;False;False;;False;0
...
ASEEND*/
//CHKSM=72B3D79C5C1B1308C0695D8CE3378D1B9339CD92